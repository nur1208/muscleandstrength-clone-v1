...
TODO ***** add all the product in storeScreen to your database
    commit -m "adding all the product in storeScreen to our database"
TODO ***** create search screen like the following: https://www.muscleandstrength.com/store/search?q=The+Ripper
TODO ***** crete search functionality for store's products
             note: when create a page for the admins, look for theme, and custom the theme to learning that skill.
TODO ***** find shopping cart theme.
TODO ***** create shopping cart screen like the following:              
TODO ***** adding shopping cart functionality
...
TODO ***** fix the style in header and footer
TODO ***** store user input in admin screen when adding products
...
TODO ***** fix "Cannot read property '_id' of null" error when the user logged out in "UsersReview"
...
return all the document in helpfulness that has the current product id and the current user id.
