TODO  make PromoScreen responsive
DONE
--------------------------------------------
...
- improve your search by add query in you url like the following :https://www.muscleandstrength.com/store/search?q=Dymatize+ISO100
      commit -m "improved search functionality by adding userInput (query) in the url like [/store/search/${searchInput}]
--------------------------------------------
Cannot do it
