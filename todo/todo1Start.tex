...
TODO delete price attribute from product modal price attribute is in supProduct.
TODO store buying options from cheaper to most expensive
TODO replace all the buttons in the web to the global button
TODO create recommend algorithm (when the user click on product store the brand and the type of the product)
TODO select default flavor for the user and the size what the user click on to view (something like TABOO)